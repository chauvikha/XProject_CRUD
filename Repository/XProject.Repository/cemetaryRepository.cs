...
{
    [ScopedDependency(ServiceType = typeof(IcemetaryRepository))]
    public class cemetaryRepository : Repository<cemetary>, IcemetaryRepository
    {
        public cemetaryRepository(IDbContext dbContext) : base(dbContext)
        {
        }
    }
}
